...
import ViewContrato from "./view_contrato"
import ModificarContratos from "./modificar_contrato";
...
function showViewMod(_contrato:Contrato){
  setShowMod(true);
  setThisContrato(_contrato);
}
...
return (
  <div>
    ...
    <ViewContrato show={show} hidden={hidden} id={contrato.id} service={service}/>
    <ModificarContratos show={showMod} hidden={hidden} contrato={contrato} service={service}/>
