...
const ViewContrato: React.FC<{
  ...
  useEffect(() => {
    ...
    if(id != "" && show){
      setLoading(true);
      service.getDependencias(id).then(
        data => {
          setFull(data.data);
        ...
        <div className='z-0'>
          <div className='z-0 grid grid-cols-6 gap-x-4 gap-y-8'>
                        ...
                        return (
                          <tr className='hover:bg-gray-100 cursor-pointer' key={generateUuid()}>
                            <td className="pl-1 py-4 whitespace-nowrap">
                              <span
                                className="pl-2 text-gray-500  text-xs leading-5 font-semibold rounded-full text-gray-500 ">
                                {indefinido.material}
                              </span>
                            </td>
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span
                                className="pl-1 text-gray-500  text-xs leading-5 font-semibold rounded-full text-gray-500 ">
            ...
            <div className='z-0 col-span-3 p-4 pt-8 row-span-2 bg-gray-50 top-4 rounded-lg  relative'>
              <div className='px-2 absolute -top-3.5 py-1 left-2 rounded-lg text-gray-100' style={{backgroundColor: '#45BF55'}}>Tickets
              </div>
