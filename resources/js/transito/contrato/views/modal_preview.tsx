  ...
  return (
    <div style={{ zIndex: 100 }}>
      <div className={show ? "block" : "hidden"} style={{ zIndex: 100 }}>
        <div
          className="fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-40"
          onClick={hidden}
          style={{ zIndex: 100 }}
        ></div>
        <div
          className="fixed | top-1/2 left-1/2 | w-1/4 | bg-white | shadow | rounded-lg"
          style={{
        ...
        >
          <div className="p-6 flex flex-wrap">
            <Preview show={true} imprimible={imprimible} imprimir={imprimir} />
          </div>
