...
const ModalClienteEliminar: React.FC<{
  show: boolean,
  hidden: any,
  id: string,
  ...
  return (
    <div className={show ? 'block' : 'hidden'}>
      ...
      <div className='fixed top-0 left-0 w-full h-full bg-gray-900 bg-opacity-40' onClick={hidden}>
      </div>
      <div className='absolute | top-1/2 left-1/2 | w-4/12 | bg-white | shadow | rounded-lg'
        ...
        <div className='w-4/6 mx-auto'>
          <p className='text-center text-gray-800 '>
            ...
            permanentemente el Cliente Seleccionado ?
          </p>
        </div>
...
export default ModalClienteEliminar;
