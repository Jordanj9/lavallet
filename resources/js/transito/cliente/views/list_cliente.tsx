            ...
            <div className="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
              ...
              <div className="z-0 bg-white w-full px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
                ...
                <div className="z-0 hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                  ...
                  <div>
                    <nav
                      className="z-0 relative z-0 inline-flex rounded-md shadow-sm -space-x-px"
                    ...
                    >
                      ...
                      <span
                        style={{ display: paginas >= 9 ? "block" : "none" }}
                        className="z-0 relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white text-sm font-medium text-gray-700"
                      >
                        ...
                      </span>
                      ...
                      <a
                        onClick={() =>
                          setPagina(pagina < paginas ? pagina + 1 : pagina)
                        }
